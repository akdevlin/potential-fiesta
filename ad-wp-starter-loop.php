...
//////Time Parameters - Show posts associated with a certain time period.
    ...
    'date_query' => array(                  //(array) - Multi Date query
                        array(
                            'after' => array(
                                'year' => '1776',
                                'month'=> '7',
                            ...
                            'inclusive' => true  //whther or not start and end dates should be included
                            ),
                            
                        ),

    'date_query' => array(                      //also accepts values compatible with strtotime string responses 
        array(
        'after' => 'July 4th, 1776',
        'before' => 'January 20th, 1776'
        'inclusive' => true
        )
    ),
    //
//////Custom Field Parameters - Show posts associated with a certain custom field.
    ...
    'meta_query' => array(                  //(array) - Custom field parameters (available with Version 3.1).
       ...
       array(
         'key' => 'price',//boolean returned from key's value and relation to the operator
         'value' => array( 1,200 ),
         'compare' => 'NOT LIKE'
       )
